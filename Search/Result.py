...
def register_default_args(parser):
    ...
    parser.add_argument('--controller_max_step',type=int,default=2,
    ...
    parser.add_argument('--dataset', '-d', default='HGBn-AMiner', type=str, help='name of datasets')
    parser.add_argument('--dataset_name',default='HGBn-AMiner',type=str,help='name of datasets')
    ...
    parser.add_argument('--predictfile', '-p', default='HGBn-AMiner', type=str, help='The file path to store predict files.')
